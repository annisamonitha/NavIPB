...
<div class="carousel-inner" role="listbox">
  ...
  <h3>Jika kamu masuk dari lobby belakang, belok kanan setelah pintu masuk, jalan terus.</h3>
</div>

<div class="carousel-inner" role="listbox">
  <img class="d-block img-fluid" src="<?php echo base_url('assets/maps/1.10.png');?>">
  <h3>Jika kamu dari lobby depan, setelah belok kanan, jalan terus kemudian belok kiri. Ruangan paling ujung di sebelah kanan itulah ruangan RK CCR 1.10</h3>
  <h3>Jika kamu dari lobby belakang, ruangan paling ujung di sebelah kanan itulah ruangan RK CCR 1.10</h3>
</div>
